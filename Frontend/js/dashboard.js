...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    // Set navbar & session fingerprint elements
    document.getElementById('navUsername').innerText = username;
    document.getElementById('dashUserDisplay').innerText = username;
    document.getElementById('navRoleBadge').innerText = userRole;
